...
const HeroSectionNoImage = (props) => {
  ...
  return (
    <section
      id="about"
      className="h-[100vh] xl:h-[70vh] flex items-center relative  pt-20 pb-2 xl:pb-10 z-1"
    >
      ...
      <div className="container grid flex-1 grid-cols-1 px-5 mx-auto xl:grid-cols-12 z-1">
        <div className="font-mono xl:col-span-5">
          <h6 className="text-xl font-medium xl:text-xl text-primary-500 dark:text-slate-300">
            Hi there I&apos;m
          </h6>
          <h2 className="mt-1 mb-5 text-3xl font-semibold leading-normal xl:text-7xl text-primary-700 dark:text-slate-200">
            {userData.name}
          </h2>
          <h4 className="text-3xl font-medium text-primary-400">
            UI/UX &
