    ...
    <header className={`main-header ${theme}`}>
      <div className="container flex justify-between items-center mx-auto px-5">
        ...
        <nav className="header-navigation">
          ...
          <Link href="/" passHref>
            <a href="replace">Projects</a>
          </Link>
          <Link href="/" passHref>
            <a href="replace">Contact me</a>
          </Link>
        </nav>
        ...
        <div className="w-28 relative group">
          ...
          <ul className="w-36 hidden absolute top-full right-0 group-hover:block bg-white rounded-lg ring-1 ring-gray-900/10 shadow-lg overflow-hidden py-1 text-sm text-gray-700 font-semibold dark:bg-gray-800 dark:ring-0 dark:highlight-white/5 dark:text-gray-300 mt-">
            <li>
              <button
